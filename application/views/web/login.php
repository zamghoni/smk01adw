     ...
     <div class="col-lg-12">
        <div class="intro-text">
            ...
            <h4 class="text-success"><br><br>
               <img src="img/logo_mts.png" width="70">
               Login Administrasi Calon Siswa
            </h4>
            <div class="col-md-12">
                <span class="text-success">Masukkan No. Pendaftaran dan NISN yang diperoleh saat melakukan pendaftaran secara online.</span><br>
            </div>
