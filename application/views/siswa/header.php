...
<body class="navbar-bottom <?php if ($menu == 'panel_siswa' and $sub_menu == 'biodata') {
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="">PPDB <label class="label label-success"> Online</label> </a>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="<?php echo base_url() . 'img/siswa/' . $foto->nama_foto ?>">
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_siswa/biodata" class="media-left"><img src="<?php echo base_url() . 'img/siswa/' . $foto->nama_foto ?>" class="img-circle img-sm" alt="foto"></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if ($menu == 'panel_siswa' and $sub_menu == 'pembayaran') {
												echo 'active';
											} ?>"><a href="pembayaran"><i class=" 	glyphicon glyphicon-usd"></i> <span>Pembayaran</span></a></li>

								<li><a href="panel_siswa/cetak" target="_blank"><i class="icon-printer2"></i> <span>Cetak Bukti Pendaftaran</span></a></li>
								<!--	<li><a href="panel_siswa/rekap_nilai" target="_blank"><i class="icon-printer4"></i> <span>Rekap Nilai Rapor</span></a></li> -->

								<!-- /Main -->

								<!-- Data Lainnya -->
								<li class="navigation-header"><span>Lainnya</span> <i class="icon-menu" title="Data visualization"></i></li>
								<li><a href="#"><i class="icon-file-download2"></i> <span>Download Panduan</span></a></li>
