...
<body class="navbar-bottom <?php if($menu=='panel_siswa' AND $sub_menu=='biodata'){echo'sidebar-xs';} ?>">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="">SIPSB <label class="label label-primary"> Online</label> </a>
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_siswa/biodata" class="media-left"><img src="img/logo_mts.png" class="img-circle img-sm" alt="foto"></a>
