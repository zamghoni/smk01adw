      ...
      <div class="panel panel-flat bg-info">
        <div class="panel-heading">
          <h3 class="panel-title">
            <center>Selamat Datang, <b><?php echo ucwords($nama); ?></b> Di Sistem Informasi Penerimaan Siswa Baru SMK NU 01 Adiwerna</center>
          </h3>
        </div>
      </div>
      <!-- /basic datatable -->
            ...
            <div class="panel panel-flat bg-success">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <center>
                    <i class="glyphicon glyphicon-bullhorn"></i> Selamat <b><?php echo $nama; ?></b> <span class="label label-info" style="font-size:20px;">Lulus</span> Seleksi Sebagai Calon Siswa Baru <b>SMK NU 01 Adiwerna</b>,<p>Silahkan Cetak Surat Bukti Lulus Seleksi.</p> 
                    ...
                    <a href="panel_siswa/cetak_nilai" class="btn btn-danger btn-lg" target="_blank"><i class="icon-printer4"></i> Cetak Nilai</a>
                  </center>
                </h4>
              </div>
            </div>
              ...
              <div class="panel-heading">
                <h4 class="panel-title">
                  <center>
                    ...
                    Sebagai Calon Peserta Didik Baru <b>SMK NU 01 Adiwerna</b>.
                  </center>
                </h4>
              </div>
            </div>
