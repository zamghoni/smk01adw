          ...
          <tbody>
              ...
              foreach ($v_siswa->result() as $baris) {?>
                <tr>
                  ...
                  <td><a href="https://api.whatsapp.com/send?phone=<?php echo $baris->telp_siswa; ?>&text=Selamat%20, Data%20anda%20telah%20kami%20verifikasi%20,%20TTD%20SMK%20NU%2001%20ADIWERNA" target="_blank" ><i class="glyphicon glyphicon-bell"></i></a> <?php echo $baris->telp_siswa; ?></td>
                  ...
                  <td align="center">
                    ...
                    <?php if ($baris->status_verifikasi == 0) {?>
                      <a href="panel_admin/verifikasi/cek/<?php echo $baris->no_pendaftaran; ?>" class="btn btn-info btn-xs" title="Verifikasi" onclick="return confirm('apakah anda yakin ingin mengubah data?')"><i class="icon-checkmark4"></i></a>
                    <?php }else{ ?>
                      <a href="panel_admin/verifikasi/cek/<?php echo $baris->no_pendaftaran; ?>" class="btn btn-danger btn-xs" title="Batal Verifikasi" onclick="return confirm('apakah anda yakin ingin mengubah data?')"><i class="icon-cross3"></i></a>
                    <?php } ?>
                  </td>
                </tr>
              <?php
