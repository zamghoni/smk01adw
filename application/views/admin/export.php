...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <table width="100%" border="1">
      <tr>
        <th rowspan="4">No.</th>
        <th rowspan="3" colspan="12">BIODATA SISWA</th>
        <th colspan="25">NILAI RAPOR</th>
      ...
      foreach ($v_siswa->result() as $baris):
        ...
        $rata_rata_rapor = number_format(($ipa->rata_rata_nilai+$mtk->rata_rata_nilai+$ind->rata_rata_nilai+$ing->rata_rata_nilai)/4,2,",",".");
