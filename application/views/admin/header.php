...
<head>
	...
	<?php
	if ($sub_menu == "verifikasi" or $sub_menu == "set_pengumuman" or $sub_menu == "seleksi" or $sub_menu == "peringkat" or $sub_menu == "cbt" or $sub_menu == "daftar_ulang") {?>
		<!-- Theme JS files -->
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="img/admin.jpg" alt="foto">
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_admin/profile" class="media-left"><img src="img/admin.jpg" class="img-circle img-sm" alt="foto"></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if($menu == 'panel_admin' AND $sub_menu == 'export'){echo 'active';} ?>"><a href="panel_admin/export"><i class="icon-file-excel"></i> <span>Export Data Calon Siswa</span></a></li>

								<li class="<?php if($menu == 'panel_admin' AND $sub_menu == 'set_pengumuman'){echo 'active';} ?>"><a href="panel_admin/set_pengumuman"><i class="icon-display4"></i> <span>Kelulusan</span></a></li>
								<li>
									<a href="panel_admin"><i class="glyphicon glyphicon-star"></i> <span>Data Nilai</span></a>
									<ul>
										<li class="<?php if($sub_menu == 'panel_admin'){echo 'active';} ?>"><a href="panel_admin/seleksi">Nilai Wawancara</a></li>
										<li class="<?php if($sub_menu == 'panel_admin'){echo 'active';} ?>"><a href="panel_admin/cbt">Nilai CBT</a></li>
										<li class="<?php if($sub_menu == 'panel_admin'){echo 'active';} ?>"><a href="panel_admin/peringkat">Kelulusan</a></li>
									<!--	<li class="<?php if($sub_menu == 'panel_admin'){echo 'active';} ?>"><a href="panel_admin/per_tdklulus">Tidak Lulus</a></li> -->
									</ul>
								</li>
