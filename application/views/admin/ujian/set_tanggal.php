        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"> Edit Tanggal Ujian</legend>
                <?php
                ...
                <form class="form-horizontal" action="" method="post">
                  ...
                  <div class="col-lg-9">
                    <input type="date" name="tanggal" class="form-control" placeholder="Contoh : 25 November 2019" value="<?php echo $web->tgl_ujian; ?>">
                  </div>
                </div>
                  <hr>
                  <a href="panel_admin/seleksi" class="btn btn-default"><< Kembali</a>
