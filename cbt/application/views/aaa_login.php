		...
		<div class="panel panel-default top150">
			...
			<div class="panel-body">
				...
				<div class="input-group">
					...
					<input type="text" id="username" name="username" autofocus value="" placeholder="No Pendaftaran" class="form-control" />
				</div> <!-- /field -->
				...
				<small><i>* Password menggunakan NISN</i></small>
...
<a href="<?php echo base_url('../') ?>"><button class="button btn btn-info btn-large col-lg-12 top15">Back To Homepage</button></a>
	</div>
	<div class="col-md-4"></div>

</div> 
<hr>
<div class="ctr"> &copy; <b>SMK NU 01 ADIWERNA</b> - Ruang Test Online. </div>
<!-- /footer --> 
<!-- Le javascript
================================================== --> 
