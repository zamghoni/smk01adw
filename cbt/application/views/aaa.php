...
<body>
  ...
  <nav class="navbar navbar-findcond navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand">Ruang Ujian Online | <b>SMK NU 01 ADIWERNA</b></a>
      </div>
  ...
  <div class="container" style="margin-top: 70px">
    ...
    <div class="col-lg-12 row">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <a href="<?= base_url('../Web/logcs_sso?username=' . $this->session->userdata('admin_user') . '&pw=' . $this->session->userdata('admin_konid') . '') ?>" class="btn btn-sq btn-primary"><i class="glyphicon glyphicon-log-in g3x"></i><br><br />Kembali ke panel</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-12" style="border-top: solid 4px #ddd; text-align: center; padding-top: 10px; margin-top: 50px; margin-bottom: 20px">
      &copy; <?php echo date('Y') ?> <a href="<?php echo base_url(); ?>adm">Ruang Ujian Online</a>.
    </div>
